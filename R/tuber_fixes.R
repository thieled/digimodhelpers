#' # NOTE:
#' # These functions fix some issues in the gojiplus/tuber package,
#' # until pull requests have been merged into master.
#' # NOTE: 2024-04-04 No longer needed as merged into master.
#'
#' #' Get Playlist Items
#' #'
